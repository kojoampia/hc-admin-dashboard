...
export class ProfessionalComponent implements OnInit {
      ...
      .pipe(
        ...
        tap(() => {
          if (this.professionals().length === 0) {
            ...
            this.professionals.set(this.refineData(this.professionals()));
          }
        }),
      )
      .subscribe();
  ...
  delete(professional: IProfessional): void {
    const modalRef = this.modalService.open(ProfessionalDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.professionals.set(this.refineData(dataFromBody));
  }

  protected refineData(data: IProfessional[]): IProfessional[] {
