...
import { EntityArrayResponseType, PatientPlanService } from '../service/patient-plan.service';
import { PatientPlanDeleteDialogComponent } from '../delete/patient-plan-delete-dialog.component';

@Component({
  selector: 'hpd-patient-plan',
...
export class PatientPlanComponent implements OnInit {
  ...
  patientPlans = signal<IPatientPlan[]>([]);
  isLoading = false;
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.patientPlans.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IPatientPlan[] | null): IPatientPlan[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.patientPlanService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
