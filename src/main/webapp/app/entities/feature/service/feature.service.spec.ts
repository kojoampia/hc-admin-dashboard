...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../feature.test-samples';
  ...
  describe('Service methods', () => {
    ...
    describe('compareFeature', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { id: 'c9f6aa8f-47ba-4778-a4a6-6c9fc1697cb7' };
        const entity2 = null;
      ...
      it('should return false if primaryKey matches', () => {
        const entity1 = { id: 'c9f6aa8f-47ba-4778-a4a6-6c9fc1697cb7' };
        const entity2 = { id: 'c9f6aa8f-47ba-4778-a4a6-6c9fc1697cb7' };
