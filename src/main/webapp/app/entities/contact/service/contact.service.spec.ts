...
import { sampleWithFullData, sampleWithNewData, sampleWithPartialData, sampleWithRequiredData } from '../contact.test-samples';
  ...
  describe('Service methods', () => {
    ...
    describe('compareContact', () => {
      ...
      it('should return false if one entity is null', () => {
        const entity1 = { id: '7c40bcce-e148-4825-ba15-5d2a47d54fc5' };
        const entity2 = null;
      ...
      it('should return false if primaryKey differs', () => {
        const entity1 = { id: '7c40bcce-e148-4825-ba15-5d2a47d54fc5' };
        const entity2 = { id: 'c6a2126a-6c84-47e8-837d-7c3a29970082' };
      ...
      it('should return false if primaryKey matches', () => {
        const entity1 = { id: '7c40bcce-e148-4825-ba15-5d2a47d54fc5' };
        const entity2 = { id: '7c40bcce-e148-4825-ba15-5d2a47d54fc5' };
