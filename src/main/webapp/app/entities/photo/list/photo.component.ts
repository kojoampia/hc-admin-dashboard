...
export class PhotoComponent implements OnInit {
  ...
  trackId = (item: IPhoto): string => this.photoService.getPhotoIdentifier(item);
  ...
  delete(photo: IPhoto): void {
    const dialogRef = this.dialog.open(PhotoDeleteDialogComponent, { width: '640px', disableClose: true });
