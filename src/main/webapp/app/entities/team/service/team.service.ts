...
type RestOf<T extends ITeam | NewTeam> = Omit<T, 'createdDate' | 'modifiedDate'> & {
...
export class TeamService {
  ...
  protected convertDateFromClient<T extends ITeam | NewTeam | PartialUpdateTeam>(team: T): RestOf<T> {
    return {
      ...
      modifiedDate: team.modifiedDate?.toJSON() ?? null,
    };
  }
  ...
  protected convertDateFromServer(restTeam: RestTeam): ITeam {
    return {
      ...
      modifiedDate: restTeam.modifiedDate ? dayjs(restTeam.modifiedDate) : undefined,
    };
  }
