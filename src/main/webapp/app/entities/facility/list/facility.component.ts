...
import { EntityArrayResponseType, FacilityService } from '../service/facility.service';
...
export class FacilityComponent implements OnInit {
  ...
  trackId = (item: IFacility): string => this.facilityService.getFacilityIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.facilities.set(dataFromBody);
  }

  protected fillComponentAttributesFromResponseBody(data: IFacility[] | null): IFacility[] {
    return data ?? [];
  }
  ...
  protected queryBackend(): Observable<EntityArrayResponseType> {
    ...
    return this.facilityService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
