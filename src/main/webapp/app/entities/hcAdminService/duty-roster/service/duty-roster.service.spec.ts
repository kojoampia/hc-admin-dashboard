...
import { DutyRosterService, RestDutyRoster } from './duty-roster.service';

const requireRestSample: RestDutyRoster = {
...
describe('DutyRoster Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a DutyRoster', () => {
      ...
      service.create(dutyRoster).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a DutyRoster', () => {
      ...
      service.update(dutyRoster).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addDutyRosterToCollectionIfMissing', () => {
      ...
      it('should accept varargs', () => {
        ...
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(dutyRoster);
        expect(expectedResult).toContain(dutyRoster2);
      });
