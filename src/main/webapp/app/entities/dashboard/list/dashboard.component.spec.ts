...
describe('Dashboard Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'aa4e6674-9d45-45d3-a0ea-50ff8f71b932' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '220ca314-dada-442e-9dd8-98aa3505bb16' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.dashboards()[0]).toEqual(expect.objectContaining({ id: 'aa4e6674-9d45-45d3-a0ea-50ff8f71b932' }));
  });

  describe('trackId', () => {
    it('should forward to dashboardService', () => {
      const entity = { id: 'aa4e6674-9d45-45d3-a0ea-50ff8f71b932' };
